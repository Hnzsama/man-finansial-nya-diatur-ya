...
const xmlCell = (v: string | number, styleId: number): string =>
  `<Cell ss:StyleID="s${styleId}"><Data ss:Type="${typeof v === 'number' ? 'Number' : 'String'}">${v}</Data></Cell>`;
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
  ...
  <Styles>
    <Style ss:ID="s60"><Alignment ss:Horizontal="Left" ss:Vertical="Center" ss:WrapText="1"/>
      <Borders>
    ...
    <Style ss:ID="s61" ss:Parent="s60"><Interior ss:Color="#FFFFFF" ss:Pattern="Solid"/></Style>
    <Style ss:ID="s62"><Alignment ss:Horizontal="Center" ss:Vertical="Center"/><Borders/>
      <Font ss:FontName="Calibri" ss:Size="16" ss:Bold="1" ss:Color="#FFFFFF"/>
      <Interior ss:Color="#1B2A4A" ss:Pattern="Solid"/></Style>
    <Style ss:ID="s63"><Alignment ss:Horizontal="Center" ss:Vertical="Center"/><Borders/>
      <Font ss:FontName="Calibri" ss:Size="11" ss:Color="#A8BFDF"/>
      <Interior ss:Color="#1B2A4A" ss:Pattern="Solid"/></Style>
    <Style ss:ID="s64"><Alignment ss:Horizontal="Left" ss:Vertical="Center"/><Borders/>
      <Font ss:FontName="Calibri" ss:Size="10" ss:Bold="1" ss:Color="#475467"/>
      <Interior ss:Color="#F8FAFC" ss:Pattern="Solid"/></Style>
    <Style ss:ID="s65"><Alignment ss:Horizontal="Left" ss:Vertical="Center"/><Borders/>
      <Font ss:FontName="Calibri" ss:Size="10" ss:Color="#1A1A2E"/>
      <Interior ss:Color="#F8FAFC" ss:Pattern="Solid"/></Style>
    <Style ss:ID="s66"><Alignment ss:Horizontal="Left" ss:Vertical="Center"/>
      <Borders><Border ss:Position="Bottom" ss:LineStyle="Continuous" ss:Weight="2" ss:Color="#3B5BDB"/></Borders>
      <Font ss:FontName="Calibri" ss:Size="11" ss:Bold="1" ss:Color="#FFFFFF"/>
      <Interior ss:Color="#3B5BDB" ss:Pattern="Solid"/></Style>
    <Style ss:ID="s67"><Alignment ss:Horizontal="Left" ss:Vertical="Center"/>
      <Borders><Border ss:Position="All" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#D0D5DD"/></Borders>
      <Font ss:FontName="Calibri" ss:Size="11" ss:Bold="1" ss:Color="#344054"/>
      <Interior ss:Color="#F0F4FF" ss:Pattern="Solid"/></Style>
    <Style ss:ID="s68"><Alignment ss:Horizontal="Right" ss:Vertical="Center"/>
      <Borders><Border ss:Position="All" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#D0D5DD"/></Borders>
      <Font ss:FontName="Calibri" ss:Size="11" ss:Bold="1" ss:Color="#12B76A"/>
      <Interior ss:Color="#ECFDF3" ss:Pattern="Solid"/>
      <NumberFormat ss:Format="&quot;Rp &quot;#,##0.00"/></Style>
    <Style ss:ID="s69"><Alignment ss:Horizontal="Right" ss:Vertical="Center"/>
      <Borders><Border ss:Position="All" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#D0D5DD"/></Borders>
      <Font ss:FontName="Calibri" ss:Size="11" ss:Bold="1" ss:Color="#F04438"/>
      <Interior ss:Color="#FEF3F2" ss:Pattern="Solid"/>
      <NumberFormat ss:Format="&quot;Rp &quot;#,##0.00"/></Style>
    <Style ss:ID="s70"><Alignment ss:Horizontal="Right" ss:Vertical="Center"/>
      <Borders><Border ss:Position="All" ss:LineStyle="Continuous" ss:Weight="2" ss:Color="#3B5BDB"/></Borders>
      <Font ss:FontName="Calibri" ss:Size="12" ss:Bold="1" ss:Color="#3B5BDB"/>
      <Interior ss:Color="#EEF2FF" ss:Pattern="Solid"/>
      <NumberFormat ss:Format="&quot;Rp &quot;#,##0.00"/></Style>
    <Style ss:ID="s71"><Alignment ss:Horizontal="Left" ss:Vertical="Center"/>
      <Borders><Border ss:Position="All" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#1D2D50"/></Borders>
      <Font ss:FontName="Calibri" ss:Size="11" ss:Bold="1" ss:Color="#FFFFFF"/>
      <Interior ss:Color="#1D2D50" ss:Pattern="Solid"/></Style>
    <Style ss:ID="s72" ss:Parent="s60"><Alignment ss:Horizontal="Right" ss:Vertical="Center"/>
      <Font ss:FontName="Calibri" ss:Size="11" ss:Bold="1" ss:Color="#12B76A"/>
      <Interior ss:Color="#F6FEF9" ss:Pattern="Solid"/>
      <NumberFormat ss:Format="&quot;Rp &quot;#,##0.00"/></Style>
    <Style ss:ID="s73" ss:Parent="s60"><Alignment ss:Horizontal="Right" ss:Vertical="Center"/>
      <Font ss:FontName="Calibri" ss:Size="11" ss:Bold="1" ss:Color="#F04438"/>
      <Interior ss:Color="#FFFBFA" ss:Pattern="Solid"/>
      <NumberFormat ss:Format="&quot;Rp &quot;#,##0.00"/></Style>
    <Style ss:ID="s74" ss:Parent="s60"><Alignment ss:Horizontal="Center" ss:Vertical="Center"/>
      <Font ss:FontName="Calibri" ss:Size="10" ss:Bold="1" ss:Color="#12B76A"/>
      <Interior ss:Color="#D1FADF" ss:Pattern="Solid"/></Style>
    <Style ss:ID="s75" ss:Parent="s60"><Alignment ss:Horizontal="Center" ss:Vertical="Center"/>
      <Font ss:FontName="Calibri" ss:Size="10" ss:Bold="1" ss:Color="#F04438"/>
      <Interior ss:Color="#FEE4E2" ss:Pattern="Solid"/></Style>
    <Style ss:ID="s76"><Alignment ss:Horizontal="Center" ss:Vertical="Center"/><Borders/>
  ...
  <Worksheet ss:Name="Financial Report">
    <Table ss:ExpandedColumnCount="6" x:FullColumns="1" x:FullRows="1">
      ...
      <Row ss:Height="20">${xmlCell('Export Scope', 64)}<Cell ss:StyleID="s65"><Data ss:Type="String">${scope.toUpperCase()}</Data></Cell><Cell ss:StyleID="s60"></Cell>${xmlCell('Date Range', 64)}<Cell ss:MergeAcross="1" ss:StyleID="s65"><Data ss:Type="String">${dateFrom || 'N/A'} to ${dateTo || 'N/A'}</Data></Cell></Row>
      <Row ss:Height="20">${xmlCell('Wallet', 64)}<Cell ss:MergeAcross="4" ss:StyleID="s65"><Data ss:Type="String">${walletLabel}</Data></Cell></Row>
      <Row ss:Height="6"><Cell ss:StyleID="s60"></Cell></Row>
